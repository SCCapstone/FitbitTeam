...
export class CmainComponent implements OnInit {
  ...
  pullFitbit(){
    /* This method grabs the FitBit data and parses it into
    firebase.

    It forms an XMLHttpRequest with maximum allowance of 31
    days (see getPriorMonth() and getDate()), using userId
    and token from FitBit.
    */ 

    // This grabs fitbitToken and Id from firebase.
    var userid = firebase.auth().currentUser.uid;
    ...
    */
    ...
    // Request string for XMLHttpRequest
